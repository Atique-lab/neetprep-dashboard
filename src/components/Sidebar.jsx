...
import { LayoutDashboard, IndianRupee, Users, School, CreditCard, GraduationCap, ShieldCheck, Activity } from "lucide-react";
...
export default function Sidebar() {
  ...
  const menu = [
    ...
    { name: "Enrolments", path: "/enrolments", icon: <Activity size={20} /> },
